...
public class FragmentUtils {
    ...
    public static Fragment addFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId) {
    ...
    public static Fragment addFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId, final boolean isHide) {
    ...
    public static Fragment addFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId, final boolean isHide, final boolean isAddStack) {
    ...
    public static Fragment addFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId, final boolean isHide, final boolean isAddStack, SharedElement...
                    sharedElement) {
    ...
    public static Fragment hideAddFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment hideFragment,
            @NonNull final
            Fragment addFragment, @IdRes final int containerId, final boolean isHide, final boolean
                    isAddStack, final
            SharedElement... sharedElement) {

        putArgs(addFragment, new Args(containerId, isHide, isAddStack));
        return operateFragment(fragmentManager, hideFragment, addFragment,
                TYPE_HIDE_ADD_FRAGMENT, sharedElement);
    }
    ...
    public static Fragment addFragments(
            @NonNull final FragmentManager fragmentManager, @NonNull final List<Fragment>
            fragments, @IdRes final int
                    containerId, final int showIndex) {
    ...
    public static Fragment addFragments(
            @NonNull final FragmentManager fragmentManager, @NonNull final List<Fragment>
            fragments, @IdRes final int
                    containerId, final int showIndex, @NonNull final List<SharedElement>... lists) {
     ...
     */
    public static void removeToFragment(
            @NonNull final Fragment fragment, final boolean isIncludeSelf) {
    ...
    public static Fragment replaceFragment(
            @NonNull final Fragment srcFragment, @NonNull final Fragment destFragment, final
    boolean isAddStack) {
    ...
    public static Fragment replaceFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId, final boolean isAddStack) {
    ...
    public static Fragment replaceFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId, final boolean isAddStack, final SharedElement... sharedElement) {
    ...
    public static boolean popToFragment(
            @NonNull final FragmentManager fragmentManager, final Class<? extends Fragment>
            fragmentClass, final
    ...
    public static Fragment popAddFragment(
            @NonNull final FragmentManager fragmentManager, @NonNull final Fragment fragment,
            @IdRes final int
                    containerId, final boolean isAddStack, final SharedElement... sharedElements) {
    ...
    public static Fragment hideShowFragment(
            @NonNull final Fragment hideFragment, @NonNull final Fragment showFragment) {
    ...
    private static Args getArgs(@NonNull final Fragment fragment) {
        ...
        if (bundle == null || bundle.getInt(ARGS_ID) == 0)
            return null;
        return new Args(bundle.getInt(ARGS_ID), bundle.getBoolean(ARGS_IS_HIDE), bundle
    ...
    private static Fragment operateFragment(
            @NonNull final FragmentManager fragmentManager, final Fragment srcFragment, @NonNull
            Fragment
            destFragment, final int type, final SharedElement... sharedElements) {

        if (srcFragment == destFragment)
            return null;
        if (srcFragment != null && srcFragment.isRemoving()) {
            L.d(srcFragment.getClass().getName() + " is isRemoving");
            return null;
        }
     ...
     * @return 最后加入的fragment
     */
    public static Fragment getLastAddFragmentInStack(
    ...
    private static Fragment getLastAddFragmentIsInStack(
            @NonNull final FragmentManager fragmentManager, final boolean isInStack) {
     ...
     */
    public static Fragment getTopShowFragmentInStack(
            @NonNull final FragmentManager fragmentManager) {
    ...
    private static Fragment getTopShowFragmentIsInStack(
            @NonNull final FragmentManager fragmentManager, final Fragment parentFragment, final
    boolean isInStack) {
     ...
     */
    public static List<Fragment> getFragmentsInStack(
            @NonNull final FragmentManager fragmentManager) {
     ...
     * @return 所有fragment
     */
    public static List<FragmentNode> getAllFragments(
            @NonNull final FragmentManager fragmentManager) {
    ...
    private static List<FragmentNode> getAllFragmentsIsInStack(
            @NonNull final FragmentManager fragmentManager, final List<FragmentNode> result,
    ...
    public static boolean dispatchBackPress(@NonNull final FragmentManager fragmentManager) {
        ...
        for (int i = fragments.size() - 1; i >= 0; --i) {
            ...
            if (fragment != null && fragment.isResumed() && fragment.isVisible() && fragment
                    .getUserVisibleHint() &&
                    fragment instanceof OnBackClickListener && ((OnBackClickListener) fragment)
                    .onBackClick()) {
                return true;
            }
        }
    ...
    public static void setBackgroundColor(
            @NonNull final Fragment fragment, @ColorInt final int color) {
    ...
    public static void setBackgroundResource(
            @NonNull final Fragment fragment, @DrawableRes final int resId) {
