...
// @Ignore("can't be tested like this because a view can't be detached manually without destroying
// presenter")
public class ViewGroupMvpDelegateImplTest {
   ...
   *
   * <p>https://github.com/sockeqwe/mosby/issues/231
   */
  @Test
  ...
  private void finishViewGroup(
      int detachCount, int destroyCount, boolean configChange, boolean finishingActivity) {
