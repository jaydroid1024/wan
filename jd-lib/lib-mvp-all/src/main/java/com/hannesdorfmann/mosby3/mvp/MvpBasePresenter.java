 ...
 * the attached view.
 *
 * <p>Use {@link #ifViewAttached(ViewAction)} to interact with the view. Since the view is passive,
 ...
 *
 * <p>ifViewAttached( view -> view.showSuccessful()) }
 *
 * <p>}
 *
...
public class MvpBasePresenter<V extends MvpView> implements MvpPresenter<V> {
   ...
   *     while trying to execute the action. false, if no exception should be thrown (the action
