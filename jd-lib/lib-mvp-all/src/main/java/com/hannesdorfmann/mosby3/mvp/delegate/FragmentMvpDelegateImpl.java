...
import com.hannesdorfmann.mosby3.mvp.utils.BackstackAccessor;
import com.hannesdorfmann.mosby3.mvp.utils.PresenterManager;

import java.util.UUID;

/**
 * The default implementation of {@link FragmentMvpDelegate} Presenter is available (has view that
 * is attached) in {@link #onViewCreated(View, Bundle)} (after super.onViewCreated() is called).
 * View will be detached in {@link #onDestroyView()} from presenter, and eventually presenter will
 * be destroyed in {@link #onDestroy()}.
 *
...
public class FragmentMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
   ...
   *     screen orientation changes. Otherwise, false
   ...
   * MvpDelegateCallback#createPresenter()} to create a new presenter instance
   *
  ...
  public void onDestroyView() {
    ...
    if (DEBUG) {
      Log.d(
          DEBUG_TAG,
          "detached MvpView from Presenter. MvpView "
