...
public class BackstackAccessor {
  ...
  /**
   * As of version 1.0 of AndroidX - fragment.isInBackStack() is package private which leads to an
   * IllegalAccessError being thrown when trying to use it. This method is a temporary workaround
   * until the issue is resolved in AndroidX.
   */
