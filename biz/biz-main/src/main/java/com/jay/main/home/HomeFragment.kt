...
import com.jay.main.home.adapter.HomeRecyclerAdapter
import com.jay.main.home.contract.HomeContract
import com.jay.main.home.presenter.HomePresenter
...
class HomeFragment : BaseMVPFragment<HomeContract.View, HomePresenter>(), HomeContract.View {
    ...
    override fun getLayoutResId(): Int {
        return R.layout.biz_main_fragment_home
    }
    ...
    override fun initView(rootView: View?, savedInstanceState: Bundle?) {
        ...
        headerView = layoutInflater.inflate(R.layout.biz_main_layout_home_header, null, false)
    ...
    override fun initData() {
        ...
        adapter = HomeRecyclerAdapter(R.layout.biz_main_item_home_recycler)
    ...
    override fun onBanner(list: List<com.jay.base_component.network.bean.wan.Banner>?) {
    ...
    private fun getDetailParamMap(searchResult: com.jay.base_component.network.bean.wan.Banner): HashMap<String, Any> {
        val map = HashMap<String, Any>(3)
        map[Constants.MapKey.ID] = searchResult.id
        map[Constants.MapKey.TITLE] = searchResult.title
