 ...
 * <ul>
 * Shuffling algorithm
 * <li>{@link #shuffle(Object[])} Shuffling algorithm, Randomly permutes the specified array
 * using a default source of
 * randomness</li>
 * <li>{@link #shuffle(Object[], int)} Shuffling algorithm, Randomly permutes the specified
 * array</li>
 * <li>{@link #shuffle(int[])} Shuffling algorithm, Randomly permutes the specified int array
 * using a default source of
 * randomness</li>
 ...
 * <li>{@link #getRandomLetters(int)} get a fixed-length random string, its a mixture of
 ...
 * numbers</li>
 * <li>{@link #getRandomNumbersAndLetters(int)} get a fixed-length random string, its a mixture
 * of uppercase, lowercase
 * letters and numbers</li>
 * <li>{@link #getRandom(String, int)} get a fixed-length random string, its a mixture of chars
 * in source</li>
 * <li>{@link #getRandom(char[], int)} get a fixed-length random string, its a mixture of chars
 * in sourceChar</li>
 * </ul>
 */
public class RandomUtils {
     ...
     *
     * @param max the bound on the random number to be returned
     * @return <ul>
