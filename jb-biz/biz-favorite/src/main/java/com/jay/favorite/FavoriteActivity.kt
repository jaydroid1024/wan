...
import com.jay.favorite.adapter.FavoriteAdapter
import com.jay.favorite.contract.FavoriteContract
import com.jay.favorite.presenter.FavoritePresenter
...
class FavoriteActivity : BaseMVPActivity<FavoriteContract.View, FavoritePresenter>(),
    ...
    override fun getLayoutResId(): Int {
        return R.layout.biz_favorite_activity_favorite
    }
    ...
    override fun initView() {
        ...
        favoriteAdapter = FavoriteAdapter(R.layout.biz_favorite_item_home_recycler)
